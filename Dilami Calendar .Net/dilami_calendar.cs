...
namespace Dilami_Calendar_.Net
{
    public class DilamiCalendar
    {
        int dy, dm, dd;
        int jy, jm, jd;

        public DilamiCalendar(int JalaliYear, int JalaliMonth, int JalaliDay)
        {
        ...
        public void jalali_to_dilami(int JalaliYear, int JalaliMonth, int JalaliDay)
        {
            int DilamiYear = 0;
            int DilamiMonth = 0;
            int DilamiDay = 0;
        ...
        public void dilami_to_jalali(int DilamiYear, int DilamiMonth, int DilamiDay)
        {
            int JalaliYear = 0;
            int JalaliMonth = 0;
            int JalaliDay = 0;
        ...
        public bool isLeap(bool isJalali = false)
        {
            if (isJalali)
        ...
        public void setDilamiYear(int Year)
        {
            dy = Year;
        }


        public void setDilamiMonth(int Month)
        {
            dm = Month;
        }


        public void setDilamiDay(int Day)
        {
            dd = Day;
        }


        public void setJalaliYear(int Year)
        {
            jy = Year;
        }


        public void setJalaliMonth(int Month)
        {
            jm = Month;
        }


        public void setJalaliDay(int Day)
        {
            jd = Day;
        }


        public void setDilamiDate(int DilamiYear, int DilamiMonth, int DilamiDay)
        {
            dy = DilamiYear;
            dm = DilamiMonth;
            dd = DilamiDay;
        ...
        public void setJalaliDate(int JalaliYear, int JalaliMonth, int JalaliDay)
        {
            jy = JalaliYear;
            jm = JalaliMonth;
            jd = JalaliDay;
